...
<InputGroup size='md' className="mb-[2%]">
    ...
    <Button className="w-[50%] mb-[2%] " colorScheme="teal" onClick={handleSubmit} >Sign up </Button> 
    <p>Already have an account ? <Link href="/signin"  className='text-green-400 hover:no-underline'>Login in </Link></p>  
    </Box>
